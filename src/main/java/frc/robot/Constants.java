...
public final class Constants {
    ...
    public static final class DriveConstants {
        ...
        public static final int kFrontRightTurningMotorPort = 19;
        ...
        public static final int kFrontLeftDriveAbsoluteEncoderPort = 7;
        ...
        public static final double kBackLeftDriveAbsoluteEncoderOffsetRad = 0.469971;
        public static final double kFrontRightDriveAbsoluteEncoderOffsetRad = 0.705078;
        public static final double kBackRightDriveAbsoluteEncoderOffsetRad = 0.140137;
        public static final double kFrontLeftDriveAbsoluteEncoderOffsetRad = 0.555908;
    ...
    public static final class LimeConstants {
        ...
        public static final double kDistanceToSpeaker = 50;
        public static final double kTargetSpeakertHeight = 57.125; // Modiffy 57.125

        public static final double kDistanceToAmp = 45;
        public static final double kTargetAmpHeight = 53.375; // Modiffy 53.375
        
        public static final double kDistanceToMic = 50; // Modyffy
        public static final double kTargetMicHeight = 52; // 52.5
        
        public static final double kTargetFeedHeight = 20; // Modyffy
